...
.DESCRIPTION
This script creates custom claim rules in the existing relying party trust for the EAC.

.OUTPUT
Custom rules are added to the relying part trust for the EAC in AD FS.
